		...
		var dialog_content = [
			{
				...
				"text": "Surface scan complete. Captain's DNA signature detected on this object. Extract sample?",
				"choices": [
					{"text": "Extract DNA (-1 AP)", "action": "make_action"},
